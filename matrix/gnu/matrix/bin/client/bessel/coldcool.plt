...
set output '/home/denis/Workspace/gnupl-out/gnu/matrix/bin/client/latex/coldcool.tex'
...
plot  TN(x)    lw 3, \
      TNc(x)   lw 3 lt 1, \
      Trc(x)   lw 3 lt 2, \
      "/home/denis/Workspace/gnupl-out/gnu/matrix/bin/client/text/termking/sub0.txt" u 1:2 w l lt 2 lw 3, \
      Tcrit(x) lw 3 lt 5
