...
\begin{picture}(9060.00,5940.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \csname LTb\endcsname%%
      \put(4818,1074){\makebox(0,0)[l]{\strut{}\small \shortstack[l]{\hl{Temperature of reference point} \\ \hl{during construction $t_\textrm{Nc} / t_\textrm{rc}$}}}}%
      \csname LTb\endcsname%%
    ...
    \gplbacktext
    \put(0,0){\includegraphics[width={453.00bp},height={297.00bp}]{/home/denis/Workspace/gnupl-out/gnu/matrix/bin/client/latex/coldcool-inc}}%
    \gplfronttext
  \end{picture}%
\endgroup
\end{document}
