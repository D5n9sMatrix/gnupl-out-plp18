...
binwidth = 4
binstart = -98
load "/home/denis/Workspace/gnupl-out/gnu/matrix/bin/client/fct/hist.fct"

plot "/home/denis/Workspace/gnupl-out/gnu/matrix/bin/client/text/data18.txt" i 0 @hist ls 1,\
     ''              i 1 @hist ls 2
